...
declare class SDK {
     ...
     */
    postOnlineRivhitonlineapiSvcDocumentNew(body: types.PostOnlineRivhitonlineapiSvcDocumentNewBodyParam): Promise<FetchResponse<200, types.PostOnlineRivhitonlineapiSvcDocumentNewResponse200>>;
}
